...
val do_move_opt : move -> state -> state option
val do_move_i : move -> int -> state -> state
val do_move_i_opt : move -> int -> state -> state option
val check_move_i : move -> int -> state -> bool
